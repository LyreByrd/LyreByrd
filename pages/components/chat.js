...
class Chat extends react.Component {
  ...
  socketConnect() {
    ...
    const socket = io(`https://${process.env.PROXY_IP}:8000`, {secure: true}); //todo change to production.env host
    const feedSocket = io(`https://${process.env.PROXY_IP}:8080`, {secure: true});
